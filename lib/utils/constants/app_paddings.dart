...
class AppPaddings {
  ...
  static EdgeInsets get h6 => const EdgeInsets.symmetric(horizontal: 6);
  ...
  static EdgeInsets get l7 => const EdgeInsets.only(left: 7);
  ...
  static EdgeInsets get lr24t25 =>
      const EdgeInsets.only(top: 25, left: 24, right: 24);
  static EdgeInsets get t25b16 => const EdgeInsets.only(bottom: 16, top: 25);
